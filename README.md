...
| `heatmap_interactive.html` | ~4.8 MB | Interactive Folium map (interactive heatmap) with togglable layers |
...
└── index.html (heatmap_interactive.html)                 # Generated — interactive map
```
